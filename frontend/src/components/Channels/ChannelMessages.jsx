...
function ChannelMessages({channelId}) {
  ...
  if (!channel) {
    return <div>Loading channel...</div>;
      ...
      const secassem = messages.reverse();

  return (
    <div className="pageContainer">
          <div className="connectButtons">
        <div>
          <button className="companion-button" onClick={handleConnect}>Connect</button>
          <button className="companion-button" onClick={handleDisconnect}>Disconnect</button>
        </div>
      </div>
      ...
      <div className="message-box">
        {connected ? (
              ...
              {editMessageId === message.id ? (
                ...
                <span className="user-box">
                 <div className="reactions-wrapper">             
                  ...
                  <span className="msg"><div id="muser">{message.user}</div> <Reactions className="reactions" messageId={message.id} />   </span>
                  ...
                  <div id="mmessage">{message.msg}</div></span>
                 
                  {user.username === message.user && (
                  
                  <div className="message-controls">
                  
                      <button className="companion-button" onClick={() => openEdit(message)}>Edit</button>
                      <button className="companion-button" onClick={() => openDelete(message.id)}>
                        Delete
                      </button>
          ...
          <div className="startup-message">{user.first_name}, Welcome to Kackle. Press the connect button to join in on the nonstop fun!</div>
