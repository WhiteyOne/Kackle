...
def seed_servers():
    demo = Server(name="Indostructable", private=True, user_id=83)
    server_1 = Server(name="Fred_Myers", private=True, user_id=84)
    server_2 = Server(name="Mark 1", private=True, user_id=85)
